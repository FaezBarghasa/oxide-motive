...
pub struct NxpEngineTimer;

impl EngineTimer for NxpEngineTimer {
...
pub struct NxpPeakAndHoldPwm;
impl embedded_hal::pwm::ErrorType for NxpPeakAndHoldPwm {
    type Error = core::convert::Infallible;
}
impl embedded_hal::pwm::SetDutyCycle for NxpPeakAndHoldPwm {
    fn max_duty_cycle(&self) -> u16 { 255 }
    fn set_duty_cycle(&mut self, _duty: u16) -> Result<(), Self::Error> { Ok(()) }
}
impl PeakAndHoldPwm for NxpPeakAndHoldPwm {
